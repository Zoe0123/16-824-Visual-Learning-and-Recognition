...
class VAEEncoder(Encoder):
    def __init__(self, input_shape, latent_dim):
        ...
        _, H, W = self.input_shape
        self.fc = nn.Linear(H*W//64*256, self.latent_dim * 2)
...
class Decoder(nn.Module):
    def __init__(self, latent_dim, output_shape):
        ...
        """
        self.fc = nn.Linear(latent_dim, self.base_size[0]*self.base_size[1]*self.base_size[2])
    ...
    def forward(self, z):
        ...
        out = self.fc(z).view(-1, self.base_size[0], self.base_size[1], self.base_size[2])
