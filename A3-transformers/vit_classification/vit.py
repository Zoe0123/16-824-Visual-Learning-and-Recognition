...
class ViT(nn.Module):
    ...
    def patchify(self, images):
        ...
        images = images.reshape(N, 3, H // self.patch_dim, self.patch_dim, W // self.patch_dim, self.patch_dim)
    ...
    def forward(self, images):
        ...
        output = torch.cat((self.cls_token.repeat(N, 1, 1), patches_embedded), dim=1) # TODO (append a CLS token to the beginning of the sequence of patch embeddings)
